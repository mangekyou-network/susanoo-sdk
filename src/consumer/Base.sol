...
/// @title BaseConsumer
/// @notice Handles receiving container compute responses from Susanoo coordinator
/// @dev Contains a single public entrypoint `rawReceiveCompute` callable by only the Susanoo coordinator. Once
...
abstract contract BaseConsumer {
    ...
    /// @param node address of responding Susanoo node
    ...
    /// @notice Callback entrypoint called by Susanoo Coordinator to return container compute responses
