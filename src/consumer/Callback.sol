...
abstract contract CallbackConsumer is BaseConsumer {
    ...
    /// @dev Under the hood, creates a new subscription at the Susanoo coordinator, with `period == 0` and
    ...
    /// @param maxGasLimit max gas limit in wei used by Susanoo node in callback tx
